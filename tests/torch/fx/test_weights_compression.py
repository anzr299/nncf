...
from tests.torch.function_hook.quantization.test_weights_compression import INT4_MODES
from tests.torch.function_hook.quantization.test_weights_compression import INT8_MODES
...
from tests.torch.function_hook.quantization.test_weights_compression import EmptyModel
from tests.torch.function_hook.quantization.test_weights_compression import FunctionalModel
from tests.torch.function_hook.quantization.test_weights_compression import LinearModel
from tests.torch.function_hook.quantization.test_weights_compression import MatMulModel
from tests.torch.function_hook.quantization.test_weights_compression import SequentialMatmulModel
from tests.torch.function_hook.quantization.test_weights_compression import SimpleMoEModel
...
class TestFXTemplateWeightCompression(TemplateWeightCompression):
    ...
    @staticmethod
    @pytest.fixture
    def get_scale_estimation_ref() -> dict[str, tuple[torch.Tensor, torch.Tensor]]:
        return {
            "reg": (
                torch.tensor(
                    [
